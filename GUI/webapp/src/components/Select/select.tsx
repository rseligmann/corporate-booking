...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.ScrollUpButton
    ref={ref}
    className={classNames('select--scrollButton', className)}
    {...props}
  >
    <ChevronUp className="select--trigger--icon" />
  </SelectPrimitive.ScrollUpButton>
))
  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={classNames('select--content', {
        'select-content-popper': position === "popper",
      }, className)}
      position ={position}
      {...props}
    >
      ...
      <SelectPrimitive.Viewport
        className={classNames('select--viewport', {
          'popper-viewport': position === "popper"
        })}
      >
        {children}
        </SelectPrimitive.Viewport>
  ...
  >
    <span className='select--item--indicator'>
      <SelectPrimitive.ItemIndicator>
        <Check className="select--trigger--icon"/>
      </SelectPrimitive.ItemIndicator>
    </span>
