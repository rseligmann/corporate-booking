...
import { useServiceableAirportSearch } from '@corporate-travel-frontend/api/hooks';
...
export const ItineraryForm: React.FC<ItineraryFormProps> = ({itineraryData, updateItineraryDetails}) => {
  ...
  const getErrorMessage = (field: string) => {
    ...
    switch (field) {
      case 'origin':
        return fieldValidators.origin(itineraryData.origin.city.name as string);
      case 'destination':
        return fieldValidators.destination(itineraryData.destination.city.name as string);
      case 'startDate':
